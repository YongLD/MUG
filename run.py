...
"""
    ...
    parser.add_argument('--con-dir', type=str, default='./Con_image', help='select the output directory')
    ...
    parser.add_argument('--agent_base', action='store_true', help='Multi-agent')
...
def main():
    ...
    for _, model_name in enumerate(args.model):
        ...
        for _, dataset_name in enumerate(args.data):
            ...
            pred_root = osp.join(args.work_dir, model_name, dataset_name, eval_id)
            pred_root_meta = osp.join(args.work_dir, model_name, dataset_name)
            os.makedirs(pred_root_meta, exist_ok=True)

            prev_pred_roots = ls(osp.join(args.work_dir, model_name, dataset_name), mode='dir')
